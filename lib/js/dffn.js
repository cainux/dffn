...
(function() {
  var $, Dffn, Guide, Hero, Item, ItemGroup, Skill, SkillBuild, dffn, util;
  ...
  util = (function() {
    ...
    util.addStyles = function() {
      return $("HEAD").append("<link id='__dffn_styles' rel='stylesheet' type='text/css' href='http://localhost/dffn/lib/css/dffn.css?v=1_3'>");
    };
  ...
  Guide = (function() {
    ...
    function Guide(name, url, icon, byline, rating, votes) {
      this.name = name;
      this.url = url;
      this.icon = icon;
      this.byline = byline;
  ...
  Dffn = (function() {
    var addBuild, addGuides, addHeroes;
    ...
    Dffn.prototype.noobify = function() {
      ...
      $dffnContainer = $("      <div id='__dffn_container'>        <a class='__dffn_close'>close</a>        <h1>" + title + "</h1>        <h2>" + buildName + "</h2>        <div id='__dffn_itemgroups'></div>        <div id='__dffn_skills'></div>        <div id='__dffn_guides'></div>        <div id='__dffn_heroes'></div>      </div>    ");
    ...
    addGuides = function($container) {
      var $heroes, byline, guide, guideRow, guides, guidesTemplate, guidesTitle, icon, name, rating, url, votes, _i, _len;
      $heroes = $("#__dffn_guides", $container);
      guides = (function() {
        var _i, _len, _ref, _results;
        _ref = $("DIV.list-box.hero-tab-target:visible TABLE TR");
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          guideRow = _ref[_i];
          ...
          _results.push(new Guide(name, url, icon, byline, rating, votes));
        }
        return _results;
      })();
      if (guides.length > 0) {
        ...
        for (_i = 0, _len = guides.length; _i < _len; _i++) {
          guide = guides[_i];
          guidesTemplate.push("          <li>            <a href='" + guide.url + "'>              <div class='__dffn_guidelabel'>                <img class='__dffn_guideicon' src='" + guide.icon + "' />                <img class='__dffn_guiderating' src='" + guide.rating + "' />                <span class='__dffn_guidevotes'>" + (util.titleCase(guide.votes)) + "</span>              </div>              <div class='__dffn_guideinfo'>                <span class='__dffn_guidename' href='" + guide.url + "'>" + guide.name + "</span>                <span class='__dffn_guidebyline'>" + guide.byline + "</span>              </div>            </a>          </li>        ");
        }
        guidesTemplate.push("</ul>");
        return $heroes.append(guidesTemplate.join(""));
      } else {
        return $heroes.remove();
      }
    };
